...
function read_scroll()
{
	...
	case S_CONFUSE:
	    ...
	    r.UI.msg("your hands begin to glow %s", pick_color("red"));
		break; 
	case S_ARMOR:
	    if (cur_armor != null)
	    {
		...
		r.UI.msg("your armor glows %s for a moment", pick_color("silver"));
	    }
		break; 
	case S_HOLD:
	    /*
	...
	case S_ID_R_OR_S:
	{
	    ...
	    r.UI.msg("this scroll is an %s scroll", scr_info[obj.o_which].oi_name);
...
def:
	...
	case S_ENCH:
		...
		if (rnd(2) == 0)
		    ...
		    cur_weapon.o_dplus++;
		r.UI.msg("your %s glows %s for a moment",
	...
	case S_PROTECT:
		...
		r.UI.msg("your armor is covered by a shimmering %s shield",
		    pick_color("gold"));
	    }
	    else
		r.UI.msg("you feel a strange sense of loss");
